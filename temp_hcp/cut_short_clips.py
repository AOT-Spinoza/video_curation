...
cut_dir = Path("/tank/shared/2024/visual/AOT/derivatives/stimuli/HCPmovies/short_clips_20s")
...
def cut_video_into_short_clips(video, output_dir, gap=1, duration=20):
